...
exports.genCode = (req, res) => {
  ...
  tableinfo.getTableColInfo(tableName, (fileds) => {
    ...
    genInfo.modelVarName = modelName
      ? getModelVarName(modelName)
      : getModelVarName(tableName);
      ...
      case "c":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}Controller.java`)
          );
      ...
      case "s":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}POService.java`)
          );
      ...
      case "p":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}PO.java`)
          );
      ...
      case "v":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}VO.java`)
          );
      ...
      case "m":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}POMapper.java`)
          );
      ...
      case "x":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}POMapper.xml`)
          );
      ...
      case "lv":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}List.vue`)
          );
          res.end(fileutil.str2buff(tpl.genListView(genInfo)));
        }
        break;
      ...
      case "fv":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}Form.vue`)
          );
          res.end(fileutil.str2buff(tpl.genFormView(genInfo)));
        }
        break;
      ...
      case "sv":
        {
          res.set(
            "Content-Disposition",
            contentDisposition(`${genInfo.modelName}ShowInfoDialog.vue`)
          );
          res.end(fileutil.str2buff(tpl.genShowInfoView(genInfo)));
        }
        break;
    }
  });
...
function jdbc2JavaType(jdbcType) {
  if (
    startsWithIgnoreCase(jdbcType, "CHAR") ||
    ...
    startsWithIgnoreCase(jdbcType, "DATETIME") ||
    ...
    startsWithIgnoreCase(jdbcType, "BIGINT") ||
    startsWithIgnoreCase(jdbcType, "INT") ||
    startsWithIgnoreCase(jdbcType, "TINYINT")
  ) {
    return "Integer";
  } else if (
    startsWithIgnoreCase(jdbcType, "NUMBER") ||
